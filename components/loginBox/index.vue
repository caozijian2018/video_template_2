    ...
    <div class="fixd">
        <div class="width_40 pcs loginbox">
            ...
            <div class="width_65 margin_auto">
                ...
                <video-button class="margin_top_20 width_100" :button-text="$t('words.login')"  @click.native="regist2login"></video-button>
        ...
        methods: {
            getLpUrl(){
                ...
                switch (this.platform){
                    case "tw":(()=>{
                        url="http://static.humorboom.com/tw/tw1/x-lp-funny.html";
                    })();break;
                    default:(()=>{
